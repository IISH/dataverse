 ...
 */
public class ClioinfraXLSXFileReaderSpi extends TabularDataFileReaderSpi{

  private static Logger LOG = Logger.getLogger(ClioinfraXLSXFileReaderSpi.class.getPackage().getName());
   ...
   * Construct  Object
   */
  public ClioinfraXLSXFileReaderSpi() {
    super("HU-IQSS-DVN-project", "4.0", formatNames, extensions, mimeType, ClioinfraXLSXFileReaderSpi.class.getName());
    LOG.fine(ClioinfraXLSXFileReaderSpi.class.getName()+" is called");
  }
  ...
  public TabularDataFileReader createReaderInstance(Object ext) throws IOException {
    return new ClioinfraXLSXFileReader(this);
  }
}